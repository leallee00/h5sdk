...
util.codegen = __webpack_require__(44);
util.fetch   = __webpack_require__(45);
util.path    = __webpack_require__(46);
...
util.base64 = __webpack_require__(35);
...
var _pb = __webpack_require__(49);
...
function getInstance(options) {
  ...
  mySocket.EnterRoomReadyReq = function (params, opts) {
    if (!mySocket.roomId) {
      console.log('%c \u8FDB\u623F\u95F4\u6210\u529F\u89E6\u53D1\u8BF7\u6C42\uFF0C\u804A\u5929\u5BA4roomId\u4E0D\u5B58\u5728', 'color:#FF7F24');
      return;
    }
    var jsonobj = {};
...
var protobuf = __webpack_require__(31);
var Long = __webpack_require__(8);
...
var config = {
  ...
  globalData: {},
  Long: Long,
  pbjsonurl: 'https://static.hnyequ.cn/h5/js/pbmsg/client_pb_dev.json?refresh=' + time
  /**
   * err 错误信息
   * root 加载的文件信息
   */
...
var protobuf = module.exports = __webpack_require__(33);

protobuf.build = "full";

// Parser
protobuf.tokenize         = __webpack_require__(27);
protobuf.parse            = __webpack_require__(47);
...
protobuf.BufferWriter = __webpack_require__(41);
protobuf.Reader       = __webpack_require__(10);
protobuf.BufferReader = __webpack_require__(42);
...
var pbjson = {
   ...
   * root 加载的文件信息
   */
};pb.load(pbjson.pbjsonurl, function (err, root) {
  if (err) {
    console.log('error loading protobuf file:config.js');
    return;
  }
  pbjson.pbMsgRoot = root;
